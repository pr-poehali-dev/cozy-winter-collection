        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
            ...
            <section className="vintage-card p-8 rounded-2xl">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  каждый заказ мы упаковываем с душой и заботой — в крафтовую бумагу,
                  с наклейками и маленькими сюрпризами внутри 🎁
                </p>
                <p>
                  если это подарок, можем добавить открытку с вашими пожеланиями —
            ...
            <section className="vintage-card p-8 rounded-2xl bg-cream/50">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <ol className="space-y-3 ml-6">
                  ...
                  <li>5. после оплаты мы начнём создавать ваш заказ ✨</li>
                  <li>6. отправим номер для отслеживания посылки</li>
                </ol>
                <p className="pt-4">
                  если остались вопросы — пишите в телеграм, с радостью ответим! 💗
                </p>
              </div>
            </section>
          </div>

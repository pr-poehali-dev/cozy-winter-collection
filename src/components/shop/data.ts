...
export const products: Product[] = [
  ...
  },
  {
    ...
    storyDescription: 'маленькое лесное чудо, которое не только украшает, но и помогает 🍄 внутри помещается помада, духи или любая мелочь цилиндрической формы. крепится к сумочке, ремешку или связке ключей — и помада всегда под рукой, не нужно рыться в сумке! красиво и удобно одновременно ✨💄',
    stock: 3,
    variants: [
      { 
        id: 'embroidered', 

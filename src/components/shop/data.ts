...
export const products: Product[] = [
  ...
  },
  {
    ...
    composition: 'дерево, акрил\nдиаметр: 10 см\nс подвесом из натурального шпагата'
  },
  {
    id: 7,
  ...
  },
  {
    ...
    composition: 'состав варьируется\nв каждом боксе: чепчик, грибочек, гирлянда, подвес\nупаковано в крафтовую коробку с лентами'
  }
];
...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: 'вязаный грибочек-подвес с расшивкой',
    price: 1500,
    category: 'аксессуары',
    image: 'https://cdn.poehali.dev/files/2c6548e3-c200-44f5-b17f-560c5ef9c0b8.jpg',
    storyDescription: 'маленькое лесное чудо 🍄 красный грибочек-мухомор с серебристой расшивкой будто только что вырос под старым дубом в волшебном лесу. каждая бисеринка вручную пришита с любовью. повесь его дома — и он принесёт уют осеннего леса, запах мха и сказки 🌿✨',
    stock: 1,
    variants: [
      { 
        id: 'embroidered', 

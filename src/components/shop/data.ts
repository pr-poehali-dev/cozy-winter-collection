...
export const products: Product[] = [
  ...
  {
    id: 10,
    name: 'г и р л я н д а 🔴 :: красные прямоугольники',
    description: 'бумажная гирлянда с прямоугольными флажками',
    price: 800,
    category: 'для дома',
    image: 'https://cdn.poehali.dev/projects/a129e1cc-3cd9-4834-888d-cf7eed2f1b72/files/753061d1-f040-470c-a162-5ceae69e1be8.jpg',
    storyDescription: 'нежная гирлянда из красных прямоугольных флажков 🔴 создаёт атмосферу тепла и волшебства. повесь её над окном, кроватью или камином — и дом наполнится сказочным уютом ✨',
    composition: 'длина: 2 метра\nбумага плотная, крафтовая\nручная работа',
    stock: 10
  }
];
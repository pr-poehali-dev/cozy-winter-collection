...
export const products: Product[] = [
  ...
  },
  {
    ...
    storyDescription: 'пыльно-зелёный, как мох на старых камнях на пути в домик хоббита! 🧝🏼‍♀️🌿 этот свитер-паутинка напомнит о лесных прогулках и тишине. скоро появится в магазине ✨',
    composition: '75% мохер, 25% шёлк\nручная стирка в холодной воде\nсушить в горизонтальном положении',
    badge: 'soon',
    stock: 5,
    gallery: [

    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-orange-50 to-amber-50 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        ...
        <div className="space-y-6">
          <p className="text-base md:text-lg text-muted-foreground my-3">магазинчик рукотворных вещиц azaluk откроется через... 🔮</p>
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <div className="space-y-4 text-left text-muted-foreground leading-relaxed max-w-xl">
            ...
            <div className="flex gap-3">
              <span className="text-2xl flex-shrink-0">🍄</span>
              <p><strong className="text-primary font-medium">задорные подвесы</strong> — подвески, которые приносят уют в дом</p>
            </div>
            <div className="flex gap-3">
              <span className="text-2xl flex-shrink-0">🪄</span>

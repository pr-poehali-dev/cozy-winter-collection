...
Отслеживайте заказ в мобильном приложении Ozon

Связаться с поддержкой можно тут:
💌  https://t.me/azaluk_care'''
        },
        'delivered': {
            'subject': 'Тепло от azaluk.shop',
            'html': f'''Привет!

На связи azaluk.shop! 

Надеемся, наши вещицы принесут вам радость и тепло! ☁️🍄🕊️

Будем очень рады вашему отзыву — поделитесь, как наши вещицы обжились в вашем мире 💕 Оставить отзыв можно тут:

...
На связи azaluk.shop, ваш заказ успешно оплачен, и мы уже начали собирать его ☁️🕊️

Мы пришлём вам письмо, когда заказ будет отправлен 📦

Детали заказа и отслеживание доступны на сайте:
{order_url}

Связаться с поддержкой можно тут:
https://t.me/azaluk_care'''
        },
        'shipped': {
            'subject': f'Заказ {order_number} отправлен',
            'html': f'''Привет!

На связи azaluk.shop, ваш заказ упакован и отправлен 📦

Адрес доставки: {order['delivery_address']}

Мы пришлём вам письмо, когда заказ будет доставлен 🎉

Отследить заказ можно тут:
{order_url}
...
На связи azaluk.shop, ваш заказ доставлен! 🎉

Надеемся, что он приносит вам радость и тепло ☁️

Будем очень рады вашему отзыву — это помогает другим находить свои вещи с душой 💗
Оставить отзыв можно тут:
https://t.me/azalukk/4001
